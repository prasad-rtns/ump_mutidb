...
import { CountryService, StateService, CityService, CategoryService, TagService, DocumentTypeService, SettingsService } from '../services/master.service';
...
export const CountryController = {
  async list(req: Request, res: Response) { return ResponseUtil.success(res, await (await CountryService.create(db(req))).listAll()); },
