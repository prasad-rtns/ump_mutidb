...
export const MASTER_SCHEMA: Record<string, EntityMeta> = {
  ...
  categories: {
    ...
    listColumns: ['name', 'code', 'categoryType', 'sortOrder', 'isActive'],
    ...
    fields: [
      ...
      { name: 'categoryType', label: 'Category Type', type: 'select',  default: 'admin category',
        options: [
          { value: 'admin category', label: 'Admin Category' },
  ...
  settings: {
    ...
    fields: [
      { name: 'key',         label: 'Key',          type: 'text',    required: true, maxLength: 200, placeholder: 'external.apim.devportalUrl' },
      { name: 'value',       label: 'Value',        type: 'textarea', placeholder: 'https://example.com' },
      { name: 'type',        label: 'Type',         type: 'select',  default: 'text',
        options: [
      ...
      { name: 'description', label: 'Description',  type: 'textarea', placeholder: 'Configurable application value' },
      { name: 'category',    label: 'Category',     type: 'select',    default: 'general', placeholder: 'Select Category' },
